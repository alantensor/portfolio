...
export default function About() {
  return (
    <section className="mb-16">
      ...
      <p className="text-neutral-700 dark:text-neutral-300 leading-relaxed mb-6">
         Was an intern on the DevOps Agent team at <Link href="https://aws.amazon.com">AWS</Link>. Worked on maps and flood detection for North American rail at <Link href={"https://tetratech.com"}>Tetra Tech</Link>.
      </p>
      <p className="text-neutral-700 dark:text-neutral-300 leading-relaxed mb-6">
